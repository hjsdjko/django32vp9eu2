	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="车位类型" prop="cheweileixing">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="车位类型" prop="cheweileixing">
					<el-input v-model="ruleForm.cheweileixing"
						placeholder="车位类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.cheweitupian" label="车位图片" prop="cheweitupian">
					<file-upload
						tip="点击上传车位图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.cheweitupian" label="车位图片" prop="cheweitupian">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="车位状态" prop="cheweizhuangtai">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="车位状态" prop="cheweizhuangtai">
					<el-input v-model="ruleForm.cheweizhuangtai"
						placeholder="车位状态" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="车位简介" prop="cheweijianjie">
					<el-input
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 16px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.cheweijianjie" label="车位简介" prop="cheweijianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"900px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.cheweijianjie}}</span>
				</el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.cheweileixingOptions = "地上,地下,室内,室外".split(',')
            this.cheweizhuangtaiOptions = "已停车,空闲".split(',')
