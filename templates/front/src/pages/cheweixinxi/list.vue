...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #C7C7C7","padding":"0","margin":"10px 0 0 auto","alignItems":"center","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"30px","flexWrap":"wrap","background":"#fff","width":"100%","height":"auto","order":"1"}'>
	  ...
	  <el-button v-if="btnAuth('cheweixinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 0 0 10px","color":"#fff","borderRadius":"30px","background":"#80BBCA","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/cheweixinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
			...
			<div :style='{"border":"1px solid #758A99","padding":"30px","margin":"0","alignItems":"center","background":"#fff","display":"flex","width":"50%","fontSize":"0","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div class="item-info" :style='{"padding":"10px","overflow":"hidden","alignItems":"center","flexWrap":"wrap","flex":"1","display":"flex","height":"auto"}'>
					...
					<div :style='{"padding":"0 10px","order":"3"}'>
					  <span class="icon iconfont icon-shoucang10" :style='{"margin":"0 2px 0 0","lineHeight":"44px","fontSize":"14px","color":"#727272"}'></span>
					  <span :style='{"color":"#727272","lineHeight":"44px","fontSize":"14px"}'>{{item.storeupnum}}</span>
					</div>
				</div>
			</div>
		</div>
...
<script>
  export default {
    ...
    created() {
		...
		this.selectOptionsList.push({name:'车位类型',list:this.cheweileixingOptions,tableName: 'cheweileixing',check: -1})
      this.getFenlei();
      this.getList(1, '全部');
    },
    //方法集合
