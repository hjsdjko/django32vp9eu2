...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none"}'  label="车位类型" prop="cheweileixing">
            <el-select v-model="ruleForm.cheweileixing" placeholder="请选择车位类型" :disabled=" false  ||ro.cheweileixing" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none"}' label="车位图片" v-if="type!='cross' || (type=='cross' && !ro.cheweitupian)" prop="cheweitupian">
            <file-upload
            tip="点击上传车位图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="车位图片" prop="cheweitupian">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none"}'  label="车位状态" prop="cheweizhuangtai">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none"}' label="车位简介" prop="cheweijianjie">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="车位简介"
