...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #C7C7C7","padding":"0","margin":"10px 0 0 auto","alignItems":"center","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"30px","flexWrap":"wrap","background":"#fff","width":"100%","height":"auto","order":"1"}'>
	  ...
	  <el-button v-if="btnAuth('newstype','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 0 0 10px","color":"#fff","borderRadius":"30px","background":"#80BBCA","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/newstypeAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="sort_view" :style='{"width":"100%","margin":"10px 0 10px auto","justifyContent":"flex-end","display":"flex","order":"2"}'>
		<el-button :style='{"border":"0","padding":"0 15px","margin":"0 5px","borderRadius":"8px","background":"none"}' @click="sortClick('clicknum')">
			<span :style='{"margin":"0 4px 0 0","lineHeight":"40px","fontSize":"14px","color":"#000"}' class="icon iconfont icon-liulan12" v-if="sortType!='clicknum'"></span>
			<span :style='{"margin":"0 4px 0 0","lineHeight":"40px","fontSize":"14px","color":"#000"}' class="icon iconfont icon-jiantou35" v-else-if="sortType=='clicknum'&&sortOrder=='desc'"></span>
			<span :style='{"margin":"0 4px 0 0","lineHeight":"40px","fontSize":"14px","color":"#000"}' class="icon iconfont icon-jiantou36" v-else-if="sortType=='clicknum'&&sortOrder=='asc'"></span>
			<span :style='{"color":"#000","lineHeight":"40px","fontSize":"14px"}'>浏览</span>
		</el-button>
	</div>
