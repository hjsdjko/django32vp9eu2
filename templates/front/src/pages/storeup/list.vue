...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"none"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"0px auto 40px","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231216/f2f635e3dc004bb2975d1edbe22e7ce4.png)","width":"90%","fontSize":"20px","lineHeight":"50px","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat"}'>我的收藏</div>
